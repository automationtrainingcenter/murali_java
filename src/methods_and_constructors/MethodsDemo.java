...
public class MethodsDemo {
	...
	public void methodTwo(String name) {
		...
		System.out.println("this method accespt a string input i.e. " + name.toUpperCase());
	}
	...
	public int methodFour(int a, int b) {
		...
		System.out.println("this method accepts two integer inputs i.e a = " + a + " b = " + b);
	...
	public static void main(String[] args) {
		...
		int m4Output = obj.methodFour(10, 30);
