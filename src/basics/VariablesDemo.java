...
public class VariablesDemo {
	...
	// instance method
	public void imethod() {
		// accessing instance variable i directly inside the class instance method
		System.out.println("instance variable i =" + i);
		// accessing static variable j directly inside the class instance method
	...
	public static void main(String[] args) {
		...
		// assign some value to the static variable j
		j = 1000;
		// assign some value to the instance variable i
		// create an object this class
